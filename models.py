...
class Computer(db.Model):
    ...
    def __init__(self, description: str, image: str, price: str, case: str, motherboard: str, cpu: str, gpu: str, ram: str, memory: str, fans: str, power_supply: str, condition: str, rgb: bool) -> None:
